...
A Flask-based API for checking Free Fire player details, including nickname, region, ban status, and ban period, with multi-region support (IN, BD, PK, NA, SG‚ ME).
